...
app.post("/submit", (req, res) => {
  ...
  var adjPick = adj[Math.floor(Math.random() * adj.length)]
  var nounPick = noun[Math.floor(Math.random() * noun.length)]
  var fullRandomName = adjPick + " "+ nounPick

  res.render("index.ejs",{
    fullName: fullRandomName
  })
});
